...
Route::group(['namespace' => 'Application', 'middleware' => ['auth','subscription_check']], function () {
    ...
    Route::group(['middleware' => ['dashboard']], function () {
        ...
        Route::post('/{company_uid}/products', 'ProductController@index')->name('product-find');
...
Route::group(['namespace' => 'Application', 'middleware' => ['auth', 'subscription_check']], function () {
   // Orders
    ...
    Route::post('/order/checkout/{plan}/mollie/webhook', 'OrderController@mollie_webhook')->name('order.payment.mollie.webhook');
