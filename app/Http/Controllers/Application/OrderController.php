...
class OrderController extends Controller
{
    ...
    public function order_processing(Request $request)
    {
        ...
        // Check the order is exists
        if ($order_failed) {
            session()->flash('alert-success', __('messages.payment_failed', ['payment_number' => $request->orderId]));
            return redirect()->route('order.plans');
        }
    ...
    public function paypal(Request $request)
    {
        ...
        return $this->paypal_completed($request);
//        dd($uid);
...
//        redirect()->route('dashboard',$currentCompany->uid);
    }
