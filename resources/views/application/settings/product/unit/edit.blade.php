...
{{--    </div>--}}
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">{{ __('messages.edit_product_unit') }}</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('messages.edit_product_unit') }}
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <a class="btn btn-primary btn-sm" href="{{ route('settings.product', ['company_uid' => $currentCompany->uid]) }}">Unit </a>
                        </div>
                    </div>
