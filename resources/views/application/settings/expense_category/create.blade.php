            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('settings.expense_categories', ['company_uid' => $currentCompany->uid]) }}">{{ __('messages.expense_categories') }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ __('messages.add_expense_category') }}
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('settings.expense_categories.store', ['company_uid' => $currentCompany->uid]) }}" method="POST">
                                ...
                                <div class="form-group text-right mt-4">
                                    <button type="submit" class="btn btn-sm btn-primary">{{ __('messages.add_expense_category') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
