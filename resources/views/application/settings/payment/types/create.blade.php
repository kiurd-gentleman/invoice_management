            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('settings.payment', ['company_uid' => $currentCompany->uid]) }}">{{ __('messages.create_payment_type') }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ __('messages.create_payment_type') }}
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('messages.create_payment_type') }}</h4>
