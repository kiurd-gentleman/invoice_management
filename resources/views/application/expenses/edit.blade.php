...
{{--    </div>--}}
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">{{ __('messages.update_expense') }}</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('messages.update_expense') }}
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="media width-250 float-right">
                <div class="media-body media-right text-right">
                    <a href="{{ route('expenses.delete', ['expense' => $expense->id, 'company_uid' => $currentCompany->uid]) }}" class="btn btn-danger btn-sm text-uppercase delete-confirm">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-round-controls">Expense Edit</h4>
