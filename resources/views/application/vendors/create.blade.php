...
{{--                    <li class="breadcrumb-item"><a href="#"><i class="material-icons icon-20pt">{{get_system_setting('application_name')}}</i></a></li>--}}
...
{{--    </div>--}}
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">{{ __('messages.create_vendor') }}</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('messages.create_vendor') }}
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-round-controls">Vendor Create</h4>
