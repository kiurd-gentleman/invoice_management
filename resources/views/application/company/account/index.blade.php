...
{{--                        </div>--}}
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <!-- Task List table -->
                            <form action="{{route('settings.account.update', ['user_uid' => $user->uid])}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input name="old_password" type="password" class="form-control password"  placeholder="{{ __('messages.old_password') }}" autocomplete="nope">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
...
{{--            $(".password").delay(100).hide(0, function() {--}}
{{--                console.log('adfsafd')--}}
{{--                $(this).remove();--}}
{{--            });--}}
{{--        });--}}
