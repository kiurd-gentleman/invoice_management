...
@section('content')
    ...
    <div class="row card-group-row pt-2">
        <div id="payment_options" class="col-12">
            ...
            @if(\App\Models\SystemSetting::isMollieActive())
                <div class="card">
                    <div class="card-header" id="mollie">
                        <h5 class="mb-0">
                            <button class="btn btn-link">
                    ...
                    <div id="mollie" class="collapse show">
                        <div class="card-body">
                            <a href="{{ route('order.payment.mollie', ['plan' => $plan->slug, 'orderId' => $orderId]) }}" class="btn btn-primary">
