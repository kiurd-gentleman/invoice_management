        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="row mb-2">
                <div class="col-12 button-group mt-1">
                    <a href="{{ route('letter-head', ['company_uid' => $currentCompany->uid]) }}" class="btn  btn-sm btn-danger mt-2 text-uppercase"><i class="ft-refresh-cw"></i> {{ __('messages.clear_filters') }}</a>
