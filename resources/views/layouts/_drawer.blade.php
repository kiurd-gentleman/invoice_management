...
{{--                </li>--}}
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link" href="#" data-toggle="dropdown"><i class="la la-folder-open" style="color: #ffffff;"></i><span  style="color: #ffffff;">Deals</span></a>
                    <ul class="dropdown-menu">
...
{{--                </li>--}}
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link" href="#" data-toggle="dropdown"><i class="la la-folder-open" style="color: #ffffff;"></i><span  style="color: #ffffff;">Relation</span></a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('customers', ['company_uid' => $currentCompany->uid]) }}" ><i class="la la-users" style="color: #ffffff;"></i> Customer</a></li>
                        <li><a class="dropdown-item" href="{{ route('vendors', ['company_uid' => $currentCompany->uid]) }}"><i class="la la-users" style="color: #ffffff;"></i> Vendors</a></li>
                        {{--                        <li><a class="dropdown-item" href="{{ route('reports.profit_loss', ['company_uid' => $currentCompany->uid]) }}"><i  class="ft-minimize-2"></i > Profit OR Loss</a></li>--}}
                        {{--                        <li><a class="dropdown-item" href="{{ route('reports.expenses', ['company_uid' => $currentCompany->uid]) }}"><i  class="ft-minimize-2"></i > Expense</a></li>--}}
                    </ul>
                </li>
...
{{--                </li>--}}
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link" href="#" data-toggle="dropdown"><i class="la la-folder-open" style="color: #ffffff;"></i><span  style="color: #ffffff;">Report</span></a>
                    <ul class="dropdown-menu">
